...
| `mc-server` | `web` (port 18995) | bareiron Minecraft server manager. **Note**: the bareiron binary is currently only compiled for OpenBSD/macppc — on other platforms, compile from source or use an alternative binary. |
